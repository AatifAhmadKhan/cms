            ...
            ?>
                ...
                <?php
                    if (isset($_SESSION['user_role'])) {
                        ...
                        if ($user_role == 'Admin' && $_GET['p_id']) {
                            $post_id = $_GET['p_id'];
                            echo "<span class='text-right'><h4><a href='admin/admin_posts.php?source=editposts&p_id=$post_id'>Edit <i class='fas fa-edit'></i></a></h4></span>";
                        }
                    }
                ?>
        ...
        <?php    
            ...
            ?>
                ...
                <?php
                    ...
                    queryCheker($select_comment_query);
